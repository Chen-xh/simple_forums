    ...
    <div class="user_box">
        ...
        <form action="checkPassword" method="post">
            ...
            <div>
                ...
                <input style=" visibility:hidden" type="text" id="username" name="username" value="${sessionScope.user.username}"/>
            </div>
            <div>
                <label for="password" class="itemLabel2">输入旧密码</label>
                <input class="input_text2 " type="password" id="password" name="password"/>
            </div>
            <div>
                <label for="checkPassword" class="itemLabel2">确认旧密码</label>
